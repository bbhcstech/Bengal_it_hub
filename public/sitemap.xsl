...
<div class="wrap">
    ...
    <h1>URLs in this sitemap</h1>
    <p class="intro">This file lists the individual page URLs in this section of bengalithub.com. Search engines read this file directly — the layout below is only for humans opening it in a browser.</p>
