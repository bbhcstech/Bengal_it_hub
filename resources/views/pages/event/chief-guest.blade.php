...
<section class="bih-hackfest-section py-16">
    <div class="bih-container">
        ...
        <div class="mt-4 max-w-3xl">
            @include('partials.section-heading', ['level' => 'h1', 'eyebrow' => 'The Bengal HackFest PRAGATI 2026', 'title' => 'Chief Guest', 'intro' => 'Meet the distinguished Chief Guest of honor for PRAGATI 2026.'])
        </div>
    ...
    @push('schema')
        <script type="application/ld+json">
            {!! json_encode([
                ...
                '@type' => 'Person',
                'name' => $person[1],
                'jobTitle' => 'Chief Guest, '.$event['name'],
        ...
        @include('partials.breadcrumb-schema', ['crumbs' => [
            ...
            ['name' => 'Chief Guest', 'url' => url()->current()],
        ]])
    @endpush
@endif
@endsection
